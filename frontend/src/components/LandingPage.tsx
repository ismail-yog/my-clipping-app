            ...
            <div className="flex flex-col items-center gap-2 w-full">
              ...
              <div className="mt-1 text-center">
                <p className="text-[10px] text-[#a06070] leading-tight">
                  Google OAuth requires Client ID type <b>Web Application</b> with origin <code className="bg-black/5 px-1 py-0.2 rounded font-mono text-[9px]">http://localhost:3000</code> in Google Cloud Console.
                </p>
              </div>
            </div>
          </div>
